...
const relatedResource = {
    link: "/blog/roots-of-change",
    text: "Roots of Change: Planting Awareness, Growing a Greener Tomorrow",
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        ...
        <Breadcrumbs items={[
          { label: 'Initiatives', href: '/sustainability-initiatives' },
          { label: 'Sustainability', href: '/sustainability-initiatives' },
          { label: 'Roots of Change' }
        ]} />
              ...
              <div className="md:col-span-2">
                  <div className="space-y-6">
                    ...
                    <div className="text-lg text-muted-foreground space-y-4 text-justify">
                      <p>
                        Roots of Change is AIM Foundation’s flagship <Link href="/sustainability-initiatives" className="text-primary hover:underline">environmental education</Link> initiative, rooted in the belief that lasting transformation begins with knowledge. Our mission is to cultivate deep environmental awareness and nurture sustainable habits in communities that are most vulnerable to climate change.
                      </p>
                      <p>
                      ...
                      <p>
                        This is more than just <Link href="/educational-initiatives" className="text-primary hover:underline">education</Link>—it’s about planting the seeds of responsibility and hope, and watching them grow into a greener, more resilient tomorrow. By starting at the grassroots level, we aim to build a future where environmental care is second nature, and every individual sees themselves as part of the solution.
                      </p>
                      <p>
                      ...
                      <p>
                        Every voice we awaken through Roots of Change plants a seed of environmental responsibility. But we can’t nurture these seeds alone. Your <Link href="/individual-donation" className="text-primary hover:underline">donation</Link> helps us reach more communities, host impactful seminars, and inspire lasting change. Together, let’s grow minds that protect the Earth. <strong>Donate today—and let your support become the root of real change.</strong>
                      </p>
                    </div>
                  </div>
              </div>
