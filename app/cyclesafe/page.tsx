...
export const metadata: Metadata = {
  ...
  keywords: ['AIM Foundation', 'CycleSafe', 'menstrual health Kolkata', 'adolescent girls hygiene', 'free sanitary pads', 'menstrual health education', 'reproductive health awareness', 'menstrual hygiene India', 'cervical health workshops', 'NGO menstrual support', 'breaking period stigma'],
  robots: 'index, follow',
