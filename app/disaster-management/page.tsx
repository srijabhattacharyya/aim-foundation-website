...
export const metadata: Metadata = {
  ...
  keywords: ['AIM Foundation', 'disaster relief India', 'emergency aid NGO', 'flood relief Kolkata', 'cyclone relief West Bengal', 'earthquake relief support', 'humanitarian aid NGO India', 'disaster management AIM Foundation', 'emergency food and shelter NGO', 'medical relief camps disaster', 'community resilience programs India'],
