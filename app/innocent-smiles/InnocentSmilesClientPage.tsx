                   ...
                   <div className="md:col-span-2">
                    <div className="space-y-6">
                      <div className="text-lg text-muted-foreground space-y-4 text-justify">
                        ...
                        <p>
                          Every child deserves the chance to dream, create, and succeed—regardless of their background. Your support can help us provide art supplies, educational resources, nutritious snacks, and safe spaces for learning and expression. With your generous <Link href="/individual-donation" className="text-primary hover:underline">contribution</Link>, we can reach more children, organize more workshops, and nurture brighter, more confident futures. <strong><Link href="/individual-donation" className="text-primary hover:underline">Donate today</Link></strong> and become a part of a child’s journey toward joy, growth, and transformation. <strong>Because every innocent smile deserves to shine.</strong>
                        </p>
                      </div>
                    </div>
                  </div>
