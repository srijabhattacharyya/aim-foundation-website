...
export const metadata: Metadata = {
  ...
  keywords: [
    'AIM Foundation careers', 'NGO jobs Kolkata', 'NGO career opportunities India',
    'AIM Foundation recruitment', 'social sector jobs India', 'non profit jobs Kolkata',
    'work with AIM Foundation', 'NGO internships and careers', 'AIM Foundation HR',
    'NGO employment opportunities India', 'jobs in education NGO India', 
    'healthcare NGO jobs Kolkata', 'AIM Foundation volunteer and career openings'
  ],
  robots: 'index, follow',
