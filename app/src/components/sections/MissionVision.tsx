          ...
          {items.map((item, index) => (
            <Card key={index} className="text-center p-6 shadow-lg hover:bg-muted transition-colors duration-300">
              ...
              <CardContent>
                ...
                <Button disabled variant="outline" className="border-primary text-primary hover:bg-primary hover:text-primary-foreground transition-transform transform hover:scale-105">
                  Learn More
                </Button>
              </CardContent>
            </Card>
