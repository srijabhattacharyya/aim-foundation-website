...
function initializeAdminApp() {
    ...
    if (!serviceAccountKey) {
        const errorMessage = "Firebase Admin SDK: The FIREBASE_SERVICE_ACCOUNT_KEY environment variable is not set. Please add it to your deployment environment's secrets/variables.";
