  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        {/* Banner */}
        <section className="relative w-full h-[334px] md:h-[334px]">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 flex items-end justify-start bg-gradient-to-t from-black/10 to-transparent p-8 md:p-12 text-white">
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
              {teamMembers.map((member, index) => (
                <Card
                  key={index}
                  className="overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300 text-center animate-fade-in-up"
