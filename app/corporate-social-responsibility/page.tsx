...
export const metadata: Metadata = {
  ...
  keywords: ['CSR AIM Foundation', 'corporate social responsibility AIM Foundation', 'AIM Foundation CSR partner', 'NGO CSR projects India', 'AIM Foundation corporate partnership', 'CSR collaboration Kolkata', 'CSR NGO India', 'CSR in education AIM Foundation', 'CSR in healthcare NGO', 'women empowerment CSR AIM Foundation', 'environment CSR projects India', 'CSR compliance AIM Foundation', 'SDG partnership AIM Foundation'],
  robots: 'index, follow',
