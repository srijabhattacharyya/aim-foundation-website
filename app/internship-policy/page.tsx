...
export default function InternshipPolicyPage() {
  const schemaMarkup = {
    ...
    "description": "Our Internship Policy defines the roles, rights, and responsibilities of interns working with AIM Foundation."
  };
  ...
  return (
    <>
      <script
        ...
        key="org-schema-internship-policy"
      />
