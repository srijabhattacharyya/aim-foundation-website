...
export const metadata: Metadata = {
  ...
  keywords: ['AIM Foundation VidyaShakti', 'multilingual learning app India', 'rural education technology', 'AI-powered study app', 'first-generation learners support', 'digital education for villages', 'AIM Foundation education initiatives'],
