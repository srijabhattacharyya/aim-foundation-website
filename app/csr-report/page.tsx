            ...
            <div className="container mx-auto px-4 md:px-6">
              <div className="max-w-4xl mx-auto space-y-8 text-lg text-muted-foreground text-justify">
                ...
                <div>
                  ...
                  <p className="mt-4 font-bold text-primary">Imagine a social enterprise empowering young women in technology. By tracking participation levels, skills development, and job placements, the impact report evolves into a compelling story of transformation—one that strengthens stakeholder confidence, attracts partners, and informs strategic decisions.</p>
                </div>
                ...
                <div className="bg-card p-6 rounded-lg shadow-sm">
                 ...
                 <div>
                  <h2 className="text-2xl md:text-3xl font-bold font-headline mb-4 text-center">India’s Independent CSR Consulting Partner</h2>
