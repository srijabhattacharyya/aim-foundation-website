            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
              ...
              <div className="space-y-6">
                ...
                <div className="text-lg text-muted-foreground space-y-4 text-justify">
                   <p>
                    CareCircle is a collaborative urban health initiative by AIM Foundation, focused on delivering <strong>accessible and inclusive medical services</strong> to underserved communities across Kolkata. Through strategic partnerships with healthcare providers and community organizations, CareCircle organizes regular healthcare camps at key urban outreach centres such as <strong>Sarala Punyashram, Sarat Bose Road</strong>, and Boral Natunhat.
                  </p>
                  <p>
