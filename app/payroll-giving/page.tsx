...
export const metadata: Metadata = {
  ...
  description: 'Support social impact with AIM Foundation Payroll Giving. Enable employees to donate effortlessly, strengthen CSR goals, and create lasting community change.',
  keywords: ['payroll Giving AIM Foundation', 'workplace giving India', 'employee donation programs AIM Foundation', 'CSR payroll giving India', 'corporate giving AIM Foundation', 'monthly salary donation NGO', 'AIM Foundation payroll CSR', 'employee payroll donation India', 'workplace charity partnership', 'sustainable giving programs AIM Foundation'],
  robots: 'index, follow',
