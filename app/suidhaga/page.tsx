...
export const metadata: Metadata = {
  ...
  description:
    'AIM Foundation’s SuiDhaga trains women in tailoring and embroidery, empowering them with skills to earn income, build confidence, and support families.',
  keywords: [
    'AIM Foundation',
    'SuiDhaga',
    'women skill development India',
    'tailoring training Kolkata',
    'embroidery training NGO',
    'livelihood programs for women',
    'financial independence women',
    'women empowerment Kolkata',
    'sewing and stitching training',
    'NGO women skills initiative',
    'women dignity and empowerment',
  ],
  robots: 'index, follow',
