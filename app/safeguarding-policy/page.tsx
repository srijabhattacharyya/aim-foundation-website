...
export default function SafeguardingPolicyPage() {
  const schemaMarkup = {
    ...
    "description": "Our Safeguarding Policy prioritizes the safety and dignity of children and vulnerable individuals in all our programs."
  };
