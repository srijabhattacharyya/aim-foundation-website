...
export const metadata: Metadata = {
  ...
  keywords: ['AIM Foundation contact', 'connect AIM Foundation', 'NGO contact Kolkata', 'volunteer contact NGO', 'donation contact AIM Foundation'],
  robots: 'index, follow',
  authors: [{ name: 'AIM Foundation' }],
  openGraph: {
    type: 'website',
    url: 'https://aimindia.org.in/connect',
    title: 'Connect with AIM Foundation',
    description: 'Get in touch with AIM Foundation. We would love to hear from you.',
    images: [
      {
