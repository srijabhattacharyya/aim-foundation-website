...
export const metadata: Metadata = {
  ...
  keywords: ['AIM Foundation Roots of Change', 'AIM Foundation environmental education', 'climate change awareness NGO India', 'AIM Foundation sustainability initiative', 'Roots of Change green education', 'NGO environmental workshops Kolkata', 'community climate action India', 'AIM Foundation environmental awareness program', 'NGO fighting plastic pollution India', 'Roots of Change AIM Foundation projects'],
  robots: 'index, follow',
