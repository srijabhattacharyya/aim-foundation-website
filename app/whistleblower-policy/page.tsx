...
export default function WhistleblowerPolicyPage() {
  const schemaMarkup = {
    ...
    "description": "Our Whistleblower Policy encourages transparent and safe reporting of any unethical conduct within the organization."
  };
