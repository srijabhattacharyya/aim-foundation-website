...
export const metadata: Metadata = {
  ...
  description:
    'Join AIM Foundation’s OralScan to fight oral cancer. Free screenings, awareness, and care in underserved communities. Support early detection today.',
  keywords: [
    'AIM Foundation',
    'OralScan',
    'oral cancer screening',
    'free oral cancer checkup',
    'early detection oral cancer India',
    'oral health awareness',
    'cancer prevention camps',
