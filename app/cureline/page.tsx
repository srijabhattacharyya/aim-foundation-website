            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
              ...
              <div className="space-y-6">
                ...
                <div className="text-lg text-muted-foreground space-y-4 text-justify">
                   <p>
                    CureLine is a frontline healthcare initiative by AIM Foundation, designed to deliver <strong>essential medical services</strong> to communities that are often neglected by mainstream health systems. Through regular, on-ground <strong>healthcare camps</strong>, CureLine serves <strong>remote villages, forest-fringe settlements,</strong> and disaster-affected regions across West Bengal and beyond.
                  </p>
                  <p>
