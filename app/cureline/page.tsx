...
const DynamicDonationForm = dynamic(() => import('@/components/sections/donation-forms/CureLineDonationForm'), { ssr: false });
...
const donationProps = {
  ...
  amountDescription: "MEDICINES FOR ONE HEALTH CAMP",
};
