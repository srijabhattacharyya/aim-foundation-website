                   ...
                   <div className="md:col-span-2">
                    <div className="space-y-6">
                      <div className="text-lg text-muted-foreground space-y-4 text-justify">
                        ...
                        <p>AIM Foundation proudly offers a <strong>Free Digital Marketing Course</strong> under our flagship <strong>Skill Development Initiative</strong>. This <strong>no-cost digital marketing course</strong> is designed for <strong>students, unemployed youth, homemakers</strong>, and <strong>small business owners</strong> who want to learn digital marketing, enhance their livelihood opportunities, or build sustainable online careers.</p>
