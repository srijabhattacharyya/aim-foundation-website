                   ...
                   <div className="md:col-span-2">
                    <div className="space-y-6">
                      <div className="text-lg text-muted-foreground space-y-4 text-justify">
                        <h2 className="text-3xl md:text-4xl font-headline"><span className="font-bold">Free Digital Marketing Course</span> - A Skill Development Initiative by AIM Foundation</h2>
