                   ...
                   <div className="md:col-span-2">
                    <div className="space-y-6">
                      <div className="text-lg text-muted-foreground space-y-4 text-justify">
                        ...
                        <p>AIM Foundation is a leading <strong>skill development NGO</strong> committed to education, livelihood promotion, and community empowerment through skills. Through our skill development courses and free training initiatives, we aim to build a digitally skilled, self-reliant society.</p>
