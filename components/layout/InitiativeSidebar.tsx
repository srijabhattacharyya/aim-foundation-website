...
export default function InitiativeSidebar({ from }: InitiativeSidebarProps) {
    ...
    const getRelatedResource = () => {
        ...
        if (pathname.includes('/detect')) {
            ...
            image = { src: "/images/projects/tide-shield/tide-shield1.avif", alt: "TideShield initiative", hint: "mangrove restoration", description: "Volunteers planting mangrove saplings"};
