...
const patrons = [
  ...
  {
    name: "B B Eye Foundation",
    logo: "/images/patrons/bbeye.png",
    hint: "bb eye foundation logo",
    alt: "B B Eye Foundation"
  }
];

const Patrons = () => {
    return (
        <section id="patrons" className="py-12 md:py-20 lg:py-24 bg-card">
