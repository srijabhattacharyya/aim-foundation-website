        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
                ...
                <div className="mt-4 text-base text-muted-foreground space-y-4 text-justify">
                    ...
                    <p>
                        We partner with some of the most underserved communities in India, creating real impact through <Link href="/healthcare-initiatives" className="text-primary hover:underline">healthcare</Link>, <Link href="/educational-initiatives" className="text-primary hover:underline">education</Link>, <Link href="/sustainability-initiatives" className="text-primary hover:underline">environmental sustainability</Link>, and support for <Link href="/gender-equality-initiative" className="text-primary hover:underline">women</Link> and <Link href="/childcare-initiatives" className="text-primary hover:underline">children</Link>. Our work goes beyond providing services — we work at the roots, empowering people to uplift themselves and those around them.
                    </p>
                    <p>
