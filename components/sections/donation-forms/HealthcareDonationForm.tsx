...
export default function HealthcareDonationForm() {
  ...
  async function onSubmit(values: z.infer<typeof donationSchema>) {
    ...
    try {
      const donationData = { ...values, cause: 'Healthcare', createdAt: serverTimestamp() };
      await addDoc(collection(db, "donations"), donationData);
      toast({
        title: "Thank you for supporting our Healthcare Initiatives!",
        description: "Your donation helps provide vital medical care.",
      });
    ...
    <Card className="w-full border-0 shadow-none rounded-none">
        <CardContent className="p-6 md:p-8">
            ...
            <div className="text-center mb-8 pt-20">
                <h2 className="text-3xl font-bold font-headline">SUPPORT HEALTHCARE INITIATIVES</h2>
                <p className="text-muted-foreground">PROVIDE VITAL MEDICAL CARE</p>
            </div>
