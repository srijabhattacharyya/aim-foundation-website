...
export default function IgniteChangeDonationForm() {
  ...
  function onSubmit(values: z.infer<typeof donationSchema>) {
    console.log(values);
    toast({
      title: "Thank you for supporting the Ignite Change Initiative!",
      description: "Your support sparks action and inspires hope.",
    });
    ...
    <Card className="w-full max-w-2xl p-6 md:p-8 shadow-lg bg-card">
        <CardContent className="p-0">
            <div className="text-center mb-8">
                ...
                <p className="text-muted-foreground">SPARK A CHANGE</p>
            </div>
            ...
            <Form {...form}>
                ...
                <FormField
                    ...
                    <FormItem className="space-y-3">
                        ...
                        <FormMessage />
                        <p className="text-center text-muted-foreground pt-2">FUND A GRASSROOTS PROJECT</p>
                    </FormItem>
                    )}
                />
