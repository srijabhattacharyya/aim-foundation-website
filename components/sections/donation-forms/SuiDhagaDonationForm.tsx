...
export default function SuiDhagaDonationForm() {
  ...
  function onSubmit(values: z.infer<typeof donationSchema>) {
    ...
    toast({
      ...
      description: "Your donation helps empower women with valuable skills.",
    });
            ...
            <Form {...form}>
                ...
                <FormField
                    ...
                    <FormItem className="space-y-3">
                        ...
                        <FormMessage />
                        <p className="text-center text-muted-foreground pt-2">SPONSOR A SEWING MACHINE & TRAINING</p>
                    </FormItem>
                    )}
                />
