...
export default function CycleSafeDonationForm() {
  ...
  async function onSubmit(values: z.infer<typeof donationSchema>) {
    ...
    try {
      const donationData = { ...values, cause: 'CycleSafe', createdAt: serverTimestamp() };
      await addDoc(collection(db, "donations"), donationData);
      toast({
        title: "Thank you for supporting CycleSafe!",
        description: "Your donation empowers young girls.",
      });
