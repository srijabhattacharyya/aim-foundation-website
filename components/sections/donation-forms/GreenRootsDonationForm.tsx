...
export default function GreenRootsDonationForm() {
  ...
  const description = selectedAmount ? selectedAmount.description : "SPONSOR SAPLINGS & SUPPORT THEIR CARE";
  ...
  async function onSubmit(values: z.infer<typeof donationSchema>) {
    ...
    try {
        const donationData = { ...values, cause: 'GreenRoots', createdAt: serverTimestamp() };
